...
public class JustifiedTextView extends View implements IOwlObserver {
	...
	private void constructor(Context context, AttributeSet attrs) {
		...
		if (attrs!=null){
			...
			mColor = ContextCompat.getColor(getContext(), R.color.black);
			mColorNight = ContextCompat.getColor(getContext(),R.color.white);
